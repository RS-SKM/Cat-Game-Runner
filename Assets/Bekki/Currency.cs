...
public class Currency : MonoBehaviour
{
    ...
    private void Start()
    {
        DontDestroyOnLoad(gameObject); //this will make this object stiack around whenever we change scenes (Will be put in it's own scene called "Dontdestroyonload" but the FindObjefct will still be able to find it)
    }
